...
patch(PosStore.prototype, {
    ...
    async _processData(loadedData) {
        ...
        this.product_pack_line_by_id = loadedData["product.pack.line"];
        this.product_pack_line_by_id = loadedData["product.pack.line"].reduce(
            (acc, item) => {
                acc[item.id] = item;
                return acc;
            },
    ...
    async add_product(product, options) {
        ...
        if ("pack_parent_line_id" in options) {
            ...
            if (
                ...
                var parent_line = this.get_orderline(options.pack_parent_line_id.id);
...
patch(Orderline.prototype, {
        ...
        if (this.product.pack_ok) {
            ...
            if (this.pack_child_line_ids) {
                this.pack_child_line_ids.forEach(function (child_line_id) {
                    ...
                    if (child_line) {
                        self.order.removeOrderline(child_line);
                    }
                });
            }
        }
    ...
    get_full_product_name() {
        var name = super.get_full_product_name(...arguments);
        if (this.pack_line_id) {
            name = "> " + name;
        }
        return name;
